...
class DreameManager {
    ...
    isBlockedObject(id) {
        ...
        return Array.isArray(this.modelSpecificBlockedObjects) && this.modelSpecificBlockedObjects.includes(id);
    }
    ...
    async pollMap() {
        ...
        if (!this.mapReady.mappointer) {
            try {
                const response = await this.Miio.sendMessage('get_properties', [
